...
# This script supports multiple threats and enables dragging and dropping of the threats.
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if event.button == 1:
                ...
                # check if clicking near existing threat first
                mx, my = event.pos
                ...
                for i, (tx, ty) in enumerate(THREATS):
                    ...
                    # no hit → create new threat
                    THREATS.append([mx, my])
        ...
        if event.type == pygame.MOUSEMOTION:
            if drag_index is not None:
                THREATS[drag_index][0], THREATS[drag_index][1] = event.pos
