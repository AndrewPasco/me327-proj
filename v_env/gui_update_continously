...
#   threat_id,x,y,z; threat_id,x,y,z; ...
#
# Coordinate system:
#   user position = (0,0,0)
#   +x = right
...
BLE_TX_UUID = "62c3cf89-247b-4c0f-a70d-651080844608"   # my computer sends this signal which is received by the board 
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEMOTION:
            ...
            if drag_index is not None:
                ...
                THREATS[drag_index]["global_x"] = event.pos[0]
                THREATS[drag_index]["global_y"] = event.pos[1]
    ...
    clock.tick(30)  # this is 30 writes per second to BLE 
